...
namespace SmtpServer.Storage
{
    public interface IMailboxFilter
    {
        ...
        Task<MailboxFilterResult> CanAcceptFromAsync(ISessionContext context, IMailbox from, int size = 0);
        ...
        /// <returns>The acceptance state of the mailbox.</returns>
        Task<MailboxFilterResult> CanDeliverToAsync(ISessionContext context, IMailbox to, IMailbox from);
    }
}
